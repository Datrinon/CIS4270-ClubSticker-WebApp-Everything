...
class ProductsVM {
    ...
    public function __construct() {
        $this->productDAM = new ProductDAM(); // DAM - classes that allow you to read or write from db.
        $this->categoryDAM = new CategoryDAM(); // No need for db usage this assignment around (10.19)
        $this->errorMsg = '';
        $this->featuredProductIds = array(1, 7, 9); // dht: hardcoded productIDs. for example.
        $this->products = array();
        $this->product = '';
        $this->category = '';
    }
